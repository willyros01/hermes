...
Deployment status: the user reported the pinned deployment completed successfully on 2026-09-11. `deleteConversationForEveryoneV1` is ACTIVE and the deletion-barrier Firestore rules are deployed. Real-device acceptance remains open.
