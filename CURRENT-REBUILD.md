...
No Firebase rules/backend/configuration, notification payload/registration, PIN/auth, E2EE format, receipt authority, Outbox, groups, attachments, disappearing content or Settings lifecycle changes. Focused gates pass locally. Full baseline, exact `main` deployment, Pages verification and repeated iPhone/iPad acceptance remain required.
