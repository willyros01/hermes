...
| Area | State | Evidence / notes |
|---|---|---|
| Disappearing-message policy/model | IN PROGRESS | 0.9.6.10 materializes the pure expiry policy plus immutable server-backed first-Read authority for direct and group receipts. Each recipient/account owns an independent readAt; repeat Read cannot move it. Physical purge execution, local/offline convergence, attachments and anti-resurrection remain unfinished. |
