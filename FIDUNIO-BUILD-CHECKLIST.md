...
| Group history policy/admin controls | IN PROGRESS | Date/message-bounded policy, message-granular grant crypto, Firestore persistence/rules/runtime, and deterministic target-side conversation projection are repository-validated through 0.9.6.8. Group Info date/beginning grant controls and disappearing-content purge/anti-resurrection remain unfinished. |
