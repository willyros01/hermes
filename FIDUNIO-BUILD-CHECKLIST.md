...
- 0.9.6.25 is materialized and its full repository gate is green, but its crash-window exit criterion is unresolved: **0.0 / 0.5 earned**.
- 0.9.6.26 and later allocated builds: **0.0 earned so far**.
- **Current total: 69.5 / 100.0, reported as 70%.**

This 69.5-point ledger (70% normal status) is authoritative until another allocated build earns points or a validated item regresses.
