FIDUNIO 1.1.52 PORTABLE ACCOUNT RECOVERY VAULT — 2026-09-13: TODO Item 2 is a complete-recovery device candidate. `.fidunio` export/import, UID/keyId/revision-bound encryption, existing PIN/server recovery authority, cloud deletion/access reconciliation, Outbox anti-replay, atomic activation, reread verification and interrupted-import rollback are implemented and permanently gated. No backend change. Full baseline, main/Pages publication and destructive iPhone/iPad site-data-loss acceptance remain required.
