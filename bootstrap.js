...
/* Account-owned local data must not be rewritten before authentication determines the UID.
 * The old migratePrototypeData() function is retained only as legacy reference; it is no longer
 * executed during bootstrap. Account storage activation now precedes app.js local-state restore.
 */
