...
assert.match(worker,/const SHELL_REVISION="[^"]+";/,"the installed PWA must retain an explicit non-empty shell revision without pinning the direct-message gate to an unrelated historical build");
