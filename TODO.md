...
- FIDUNIO 1.1.34 membership projection/member discovery passed their device matrix, but item 9 is reopened by FDA-GROUP-003 until 1.1.36 join-time history-boundary deployment and device re-acceptance. The established membership transaction, key-epoch rotation, and direct two-account boundary remain unchanged.
