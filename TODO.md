...
8. **Restore the accepted full invitation letter — IMPLEMENTED IN 1.1.40; DEVICE ACCEPTANCE PENDING** — the exact accepted subject and full letter were recovered from the validated 0.9.5.1 checkpoint and safe 0.9.4.10 stabilization branch. Copy Invitation, Email Invitation and Share now use the same restored inviter introduction, assigned role, expiry, clean single-use Join URL, personal/non-forward warning, clean Quick Start Guide URL, guide summary and FIDUNIO sign-off. The current serialized invitation owner and invitation/install separation are preserved; rejected 0.9.4.12–0.9.4.15 automatic invite/install code remains absent. Verify readable line breaks and working links through Copy, Mail and Share on iPhone and iPad before closing.
