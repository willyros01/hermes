...
Current device candidate **0.9.9.9c** preserves encrypted direct text, Read receipts and Delete for Everyone, corrects returning PIN/biometric access, and adds durable local-only **Delete for Me** for sent and received messages.
...
- Current checkpoint version: **0.9.9.9c**
