...
const attachmentProjection=app.slice(app.indexOf("function projectSelectedAttachmentRecord"),app.indexOf("function createSelectedAttachmentRecord"));
...
assert.match(attachmentProjection,/if\(c\.cloudGroup\)optimisticOutgoingProjection\.stage\(c\.id,record\.stagedMessage\)/,"only group attachments may stage in the group-only owner");
