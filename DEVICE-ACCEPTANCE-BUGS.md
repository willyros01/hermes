...
- **Status:** 1.1.34 REPOSITORY CANDIDATE; full local non-emulator and all five Firestore emulator baselines pass. `main`/Pages validation and device acceptance remain pending.
