...
- **Status:** 1.1.36 DEPLOYMENT CANDIDATE. Exact implementation tree `5ec21d002765f91f091ba9e6b950fd63e02bf3f0` is on `main` as `5a6449c9165228a0f7cf75418f3dbecadc736f99`; all required repository workflows and Pages passed, and live Pages serves 1.1.36. Firestore rules deployment and device acceptance remain pending. Item 9 is reopened until this matrix passes.
