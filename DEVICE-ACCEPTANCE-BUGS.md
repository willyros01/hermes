...
- **Status:** 1.1.36 REPOSITORY CANDIDATE. Main/Pages verification, Firestore rules deployment and device acceptance remain pending. Item 9 is reopened until this matrix passes.
