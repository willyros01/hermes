...
- **Status:** REPOSITORY/PAGES VALIDATED on 1.1.33. All 82 non-emulator workflow steps and five Firestore emulator suites pass locally; all GitHub gates and Pages passed on `main`. Repeat direct/group device acceptance remains required.
